...
def seed_decks():
    ...
    seedArray.append(Deck(game_name = "Average Playing Card Deck", owner_id = "1", splash_image = "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/best-card-games-1593784219.jpg", rules = "There are many games which can be played with a 52-card deck", description = "It's a generic 52-card deck!"))
